 ...
 * @brief Produit deux images testant multiples fonctionnalités des classes Image et Pixel
 *        Produit l'exécutable bin/exemple
 *        Produit les images 1 et 2 dans le fichier data
 *
 * @version 0.1
 */
